...
// WithInstanceID adds the instanceID to the describe audit logs params
func (o *DescribeAuditLogsParams) WithInstanceID(instanceID *string) *DescribeAuditLogsParams {
	o.SetInstanceID(instanceID)
	return o
}

// SetInstanceID adds the instanceId to the describe audit logs params
func (o *DescribeAuditLogsParams) SetInstanceID(instanceID *string) {
