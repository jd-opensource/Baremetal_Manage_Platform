...
type BasicCreateInstanceTemplate struct{}

func (b BasicCreateInstanceTemplate) accept(network_type, interface_mode string) bool {
	return NetworkType.BASIC == network_type
}

func (b BasicCreateInstanceTemplate) initCommand(logger *log.Logger, request_id, instance_id, sn string, make_partitions bool, image_format string, task string) {
