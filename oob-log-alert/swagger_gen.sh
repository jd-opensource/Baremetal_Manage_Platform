...
swagger version
\rm ./swagger.yml | swagger generate spec -o ./swagger.yml
...
\rm -rf ../bmp-oob-alert-sdk/client && \rm -rf ../bmp-oob-alert-sdk/models
swagger generate client -f swagger.yml --target=../bmp-oob-alert-sdk
