...
###############用户修改部分################
readonly PACKAGE_BIN_NAME=oob-log-alert   #定义产出的运行程序名,必填项
...
function build_package()
{
    ...
    # export GOPATH=$(pwd)
	go clean
	go build -v -gcflags="-N -l" -o ${PACKAGE_BIN_NAME} ${WORKSPACE_DIR} || return 1
}
...
function copy_result
{
    ...
    dir_not_empty ${WORKSPACE_DIR}/${CONF_DIR_NAME} && mkdir -p ${OUTPUT}/${CONF_DIR_NAME};cp -rf ./${CONF_DIR_NAME}/* ${OUTPUT}/${CONF_DIR_NAME}/
