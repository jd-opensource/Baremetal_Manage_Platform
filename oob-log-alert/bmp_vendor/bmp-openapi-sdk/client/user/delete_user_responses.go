...
/*DeleteUserDefaultBody delete user default body
...
func (o *DeleteUserDefaultBody) validateRequestID(formats strfmt.Registry) error {

	if err := validate.Required("deleteUser default"+"."+"requestId", "body", o.RequestID); err != nil {
		return err
	}
...
func (o *DeleteUserDefaultBody) validateError(formats strfmt.Registry) error {
	...
	if err := validate.Required("deleteUser default"+"."+"error", "body", o.Error); err != nil {
		return err
	}
	...
	if o.Error != nil {
		if err := o.Error.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("deleteUser default" + "." + "error")
			}
			return err
		}
	}
...
// ContextValidate validate this delete user default body based on the context it is used
func (o *DeleteUserDefaultBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *DeleteUserDefaultBody) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (o *DeleteUserOKBody) validateResult(formats strfmt.Registry) error {
	...
	if o.Result != nil {
		if err := o.Result.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("deleteUserOK" + "." + "result")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("deleteUserOK" + "." + "result")
			}
			return err
		}
	}
...
// ContextValidate validate this delete user o k body based on the context it is used
...
func (o *DeleteUserOKBody) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
