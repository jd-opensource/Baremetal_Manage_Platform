...
func (m *InstanceInfo) validateInstance(formats strfmt.Registry) error {
...
func (m *InstanceInfo) contextValidateInstance(ctx context.Context, formats strfmt.Registry) error {
