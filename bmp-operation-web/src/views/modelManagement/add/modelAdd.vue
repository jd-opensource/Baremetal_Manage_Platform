<template>
    <div class="operate-management-detail model-operate">
        ...
        />
        <main class="operate-management-detail-info custom-count">
            <!-- 主体头部内容 -->
            ...
            >
                ...
                <ui-form-item
                    prop="modelCPU"
                    required
                    class="model-operate-ruleForm-model-cpu custom-radio-button"
                ...
                <ui-form-item
                    prop="modelStorage"
                    required
                    class="model-operate-ruleForm-model-storage custom-radio-button"
                                    ...
                                    <div>
                                        ...
                                        >
                                            <ui-form-item
                                                ...
                                                :label="''"
                                                :class="[
                                                    'ipt-height sys-single-capacity input-width',
                                                ]"
                                            >
                                                <ui-input
                                                    :placeholder="$t('modelForm.label.volumeManage.placeholder.tip1')"
                ...
                <div>
                    <p
                        v-if="formRulesOperate.addOptHasShow()"
                        :class="setDiffClass('en-table-error-tip', 'table-error-tip')"
                    >
                        {{formRulesOperate.addOptTipText()}}
                    </p>
                    <p
                        :class="[
                            setDiffClass('add-volume-en', 'add-volume'),
                            formRulesOperate.setAddClass(),
                            formRulesOperate.setDataClass()
                        ]"
                        @click="formRulesOperate.setAddClick"
                    >
            ...
            <div class="footer-btn">
                <ui-button :loading="formRulesOperate.isLoading.value" type="primary" @click="formRulesOperate.sure">{{$t('modelForm.label.volumeManage.btn.sure')}}</ui-button>
                <ui-button class="custom-dialog-footer-cancel-btn" @click="formRulesOperate.cancel">{{$t('modelForm.label.volumeManage.btn.cancel')}}</ui-button>
            </div>
        </main>
    </div>
</template>
