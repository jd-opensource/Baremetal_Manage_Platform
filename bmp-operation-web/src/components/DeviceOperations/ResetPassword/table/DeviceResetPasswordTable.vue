        ...
        <ui-config-provider :locale="uiLocale.locale">
            ...
            >
                ...
                <ui-table-column
                    ...
                    align="center"
                    min-width="120"
                    :label="$t('resetPassword.table.label.instanceName')"
                ...
                <ui-table-column
                    ...
                    min-width="120"
                    align="center"
                    :label="$t('resetPassword.table.label.instanceId')"
                    :has-user-template="true"
                >
                    <template #default="{scope}">
                        <ui-tooltip
                ...
                <ui-table-column
                    ...
                    align="center"
                    min-width="100"
                    :label="$t('resetPassword.table.label.outOfBandIP')"
                    :has-user-template="true"
                >
                    <template #default="{scope}">
                ...
                <ui-table-column
                    ...
                    align="center"
                    min-width="120"
                    :label="$t('resetPassword.table.label.intranceIPv4')"
                    :has-user-template="true"
                >
                    <template #default="{scope}">
