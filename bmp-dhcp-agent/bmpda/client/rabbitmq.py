...
class Consumer(object):
    ...
    def init(self, queue_name: str):
        ...
        self.routing_key = config.mq_exchange_routing_key
        ...
        self.exchange = config.mq_exchange_consumer
...
class Publisher(object):
    ...
    def init(self, routing_key):
        ...
        self.exchange_type = config.mq_exchange_type_publish
