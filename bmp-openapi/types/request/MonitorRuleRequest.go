...
func (req *AddRuleRequest) Validate(logger *log.Logger) {

	validate(req, logger)

}

///`{"alertname":"bmpInBand_mr_4msjd0x9vhw7owwur22j4fi4piqc_minping-mock-instanceId_bmp.cpu.util_","calculation":"avg","calculationUnit":"%","instanceId":"minping-mock-instanceId","metric":"bmp.cpu.util","noticeLevel":"1","noticePeriodLabel":"NoticePeriod-180m","operation":"gt","period":"1","ruleId":"mr_4msjd0x9vhw7owwur22j4fi4piqc","threshold":"1","times":"1"}`
...
func (req *DescribeRuleRequest) Validate(logger *log.Logger) {
	validate(req, logger)
}
...
func (req *DescribeRulesRequest) Validate(logger *log.Logger) {
	validate(req, logger)
}
...
func (req *EditRuleRequest) Validate(logger *log.Logger) {
...
func (req *EnableRuleRequest) Validate(logger *log.Logger) {
...
func (req *DisableRuleRequest) Validate(logger *log.Logger) {
...
func (req *DeleteRuleRequest) Validate(logger *log.Logger) {
