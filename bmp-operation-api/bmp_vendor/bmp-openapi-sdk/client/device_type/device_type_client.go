...
type ClientService interface {
	...
	DescribeVolumesByDeviceType(params *DescribeVolumesByDeviceTypeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DescribeVolumesByDeviceTypeOK, error)
...
/*
  DescribeVolumesByDeviceType DescribeVolumesByDeviceType 根据机型获取volumes
*/
func (a *Client) DescribeVolumesByDeviceType(params *DescribeVolumesByDeviceTypeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DescribeVolumesByDeviceTypeOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewDescribeVolumesByDeviceTypeParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "describeVolumesByDeviceType",
		Method:             "GET",
		PathPattern:        "/deviceTypes/{device_type_id}/describeVolumes",
		ProducesMediaTypes: []string{"application/json", "application/xml"},
		ConsumesMediaTypes: []string{"application/json", "application/xml"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &DescribeVolumesByDeviceTypeReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*DescribeVolumesByDeviceTypeOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*DescribeVolumesByDeviceTypeDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
