...
type ClientService interface {
	...
	DialMail(params *DialMailParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DialMailOK, error)
	...
	MailDetail(params *MailDetailParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*MailDetailOK, error)

	ReadMessage(params *ReadMessageParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ReadMessageOK, error)

	SaveIsPushMail(params *SaveIsPushMailParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SaveIsPushMailOK, error)
...
/*
  DialMail DialMail 测试邮箱设置是否正确
*/
func (a *Client) DialMail(params *DialMailParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DialMailOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewDialMailParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "dialMail",
		Method:             "POST",
		PathPattern:        "/messages/dialMail",
		ProducesMediaTypes: []string{"application/json", "application/xml"},
		ConsumesMediaTypes: []string{"application/json", "application/xml"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &DialMailReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*DialMailOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*DialMailDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
  MailDetail MailDetail 获取邮箱设置
*/
func (a *Client) MailDetail(params *MailDetailParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*MailDetailOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewMailDetailParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "mailDetail",
		Method:             "GET",
		PathPattern:        "/messages/mailDetail",
		ProducesMediaTypes: []string{"application/json", "application/xml"},
		ConsumesMediaTypes: []string{"application/json", "application/xml"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &MailDetailReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*MailDetailOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*MailDetailDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
  SaveIsPushMail SaveIsPushMail 保存邮箱是否通知的设置
*/
func (a *Client) SaveIsPushMail(params *SaveIsPushMailParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*SaveIsPushMailOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewSaveIsPushMailParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "saveIsPushMail",
		Method:             "POST",
		PathPattern:        "/messages/saveIsPushMail",
		ProducesMediaTypes: []string{"application/json", "application/xml"},
		ConsumesMediaTypes: []string{"application/json", "application/xml"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &SaveIsPushMailReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*SaveIsPushMailOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*SaveIsPushMailDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
