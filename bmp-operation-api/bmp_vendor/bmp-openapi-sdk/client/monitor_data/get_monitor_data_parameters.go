...
// WithIdcID adds the idcID to the get monitor data params
func (o *GetMonitorDataParams) WithIdcID(idcID *string) *GetMonitorDataParams {
	o.SetIdcID(idcID)
	return o
}

// SetIdcID adds the idcId to the get monitor data params
func (o *GetMonitorDataParams) SetIdcID(idcID *string) {
	o.IdcID = idcID
}
...
// WithUserName adds the userName to the get monitor data params
func (o *GetMonitorDataParams) WithUserName(userName *string) *GetMonitorDataParams {
	o.SetUserName(userName)
	return o
}

// SetUserName adds the userName to the get monitor data params
func (o *GetMonitorDataParams) SetUserName(userName *string) {
	o.UserName = userName
}
