...
func (m *ModifyDeviceTypeRequest) validateVolumes(formats strfmt.Registry) error {
...
// ContextValidate validate this modify device type request based on the context it is used
...
func (m *ModifyDeviceTypeRequest) contextValidateVolumes(ctx context.Context, formats strfmt.Registry) error {
