        ...
        >
            <template #title>
                <div>
                    ...
                    <span class="my-title">{{$t('list.operate.batchResetPassword')}}</span>
                    <el-button     
                        circle 
                        class="close-button" 
                        :icon="Close"
            ...
            <div class="batch-table-content m0 reset-password">
                <div class="error-tip-content mb20">
                    <div class="error error-icon"></div>
                    <span>{{$t('list.content.batchresetPasswordTip0')}}</span>
                    <p class="ml20 lh24">{{$t('list.content.batchresetPasswordTip1')}}</p>
                    <p class="ml20 lh24">{{$t('list.content.batchresetPasswordTip2')}}</p>
                </div>
                <batch-table
                    v-bind="$attrs" 
...
import {batchRepasswordAPI} from 'api/request.ts'; // 重置密码接口
 ...
 * 请求重置密码接口
*/
const requestBatchResetPassword = (): void => {
