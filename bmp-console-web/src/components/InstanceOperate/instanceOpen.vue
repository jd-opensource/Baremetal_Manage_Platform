        ...
        >
            <template #title>
                <div>
                    ...
                    <span class="my-title">{{$t('list.operate.open')}}</span>
                    <el-button     
                        circle 
                        class="close-button" 
                        :icon="Close"
            ...
            <div class="dialog-body-content">{{$t('list.content.open', [instanceInfo?.instanceName])}}</div>
            <template #footer>
                <span>
                    <el-button      
                        class="cancel-button"
...
import {instanceOpenAPI} from 'api/request.ts'; // 打开接口
/**
 * 父组件传递的props数据类型
*/
interface PropsType {
