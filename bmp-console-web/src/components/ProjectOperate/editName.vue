        ...
        >
            <template #title>
                <div>
                    ...
                    <span class="my-title">{{ $t('personCentre.detail.projectName')}}</span>
                    <el-button                      
                        circle 
                        class="close-button" 
                        :icon="Close"
            ...
            <div class="dialog-body-content">
                ...
                >
                    ...
                    >
                        ...
                        />
                        <p 
                            class="f12 c999 w390 el-form-item__error" 
                            v-if="!projectNameState"
                        >
                            {{$t('personCentre.content.stringChineseVerification')}}
                        </p>
                    </el-form-item>
                </el-form>
            </div>
